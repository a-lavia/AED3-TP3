...
mv salida.csv Complejidad/test1complejidad.csv;
...
mv salida.csv Complejidad/test2complejidad.csv;
...
mv salida.csv Complejidad/test3complejidad.csv;
...
mv salida.csv Complejidad/test4complejidad.csv;